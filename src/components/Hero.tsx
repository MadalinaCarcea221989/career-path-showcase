...
const Hero = () => {
  ...
  return <section className="min-h-screen flex flex-col relative overflow-hidden">
      ...
      <div className="absolute inset-0 bg-grid-slate-100 [mask-image:linear-gradient(0deg,white,rgba(255,255,255,0.6))] dark:bg-grid-slate-900/2"></div>
      ...
      <div className="relative z-10 flex-1 flex items-center justify-center text-center px-4 max-w-4xl mx-auto">
        <div className="animate-fade-in">
          <div className="mb-8 relative">
            ...
            <img src="/lovable-uploads/29b2731b-6f40-448a-8226-7c97a6773824.png" alt="Madalina Carcea" className="w-64 h-64 rounded-full mx-auto object-cover border-4 border-purple-500/50 shadow-2xl shadow-purple-500/30 relative z-10 neon-border" />
          ...
          <div className="mb-6">
            <h1 className="text-5xl holographic-text mb-2 md:text-7xl font-bold">
              Madalina Carcea
            </h1>
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center items-center">
            <Button size="lg" onClick={scrollToProjects} className="futuristic-button relative z-10 group">
