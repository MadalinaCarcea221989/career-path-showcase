          ...
          {projects.map((project, index) => (
            <Card key={index} className="futuristic-card group overflow-hidden">
              ...
              <CardHeader className="pb-4">
                ...
                <CardDescription className="text-sm leading-relaxed high-contrast-text">
                  {project.description}
                </CardDescription>
              </CardHeader>
                ...
                <div className="flex flex-wrap gap-2 mb-4">
                  {project.technologies.map((tech, techIndex) => (
                    <Badge 
                      key={techIndex} 
                      variant="secondary" 
                      className="text-xs px-2 py-1 bg-gradient-to-r from-indigo-500/30 to-purple-500/30 border-indigo-300/50 text-slate-100 hover:from-indigo-500/40 hover:to-purple-500/40 transition-all duration-200"
                    >
                      {tech}
                    </Badge>
                  ))}
                ...
                <div className="flex gap-3">
                  ...
                  {project.githubUrl && (
                    <a href={project.githubUrl} target="_blank" rel="noopener noreferrer">
                      <Button variant="outline" size="sm" className="flex items-center gap-2 bg-black/80 border-black hover:bg-black text-white hover:text-white transition-all duration-300">
